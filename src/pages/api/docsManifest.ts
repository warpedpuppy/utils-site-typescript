...
export const ENTRY_VISUALS: Partial<Record<string, DocVisualConfig>> = {
  ...
  circleToCircle: { kind: "example", exampleSlug: "circle-to-circle-collision", exampleLabel: "Open the circle collision example" },
  circleCircle: { kind: "example", exampleSlug: "circle-to-circle-collision", exampleLabel: "Open the circle collision example" },
  ...
  getRotation: { kind: "example", exampleSlug: "point-object-towards-another", exampleLabel: "Open the rotation example" },
  lerpAngle: { kind: "example", exampleSlug: "angle-lerp-shortest-turn", exampleLabel: "Open the angle lerp example" },
  shortestAngleBetween: { kind: "example", exampleSlug: "angle-lerp-shortest-turn", exampleLabel: "Open the angle lerp example" },
  wrapAngle: { kind: "example", exampleSlug: "angle-lerp-shortest-turn", exampleLabel: "Open the angle lerp example" },
  ...
  sineCurve: { kind: "example", exampleSlug: "sine-curve", exampleLabel: "Open the sine curve example" },
  ...
  unitCirclePoint: { kind: "example", exampleSlug: "demystify-sine-and-cosine", exampleLabel: "Open the sine/cosine unit-circle example" },
  ...
  waveAmplitude: { kind: "example", exampleSlug: "wave-interference", exampleLabel: "Open the wave interference example" },
};
...
const ENTRY_USAGE_LEADS: Partial<Record<string, string>> = {
  ...
  "SineCurve:sineCurve": "The time-driven oscillation helper: one number that rises and falls forever.",
  "SineWave:sineWave": "Use this when the oscillation lives across x-position instead of only over time.",
  "WaveAmplitude:waveAmplitude": "A higher-level wave helper: combine several sources and ask what their interference adds up to at one point.",
