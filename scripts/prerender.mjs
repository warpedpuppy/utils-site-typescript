...
import { HOST, ORIGIN, PORT, postProcess } from "./prerenderPostProcess.mjs";
...
// postProcess (origin strip + static-meta cleanup) lives in
// ./prerenderPostProcess.mjs so it can be unit-tested without booting the crawl.
